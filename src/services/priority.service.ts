...
export class PriorityService {
  ...
  private async createDbConnection() {
    ...
    await this.db.init();
    this.respository = this.db.getRepository(Priority);
  }
  ...
  // -- POST
  // ------------------------------------------------------------------------------------------------
  public async create(priority: Priority): Promise<any> {
  ...
  public async createList(prioritys: Priority[]): Promise<any> {
    let result : any = HttpStatus.CONFLICT;
  ...
  // -- PUT
  // ------------------------------------------------------------------------------------------------
  public async update(id: string, priority: Priority): Promise<any> {
    let result : any = HttpStatus.NOT_FOUND;
    ...
    try {
      ...
      if (temp != null) {
        try {
          let updateData = await getEntityForUpdate(priority, 'Priority');
