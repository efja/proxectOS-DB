...
export class UserContactTypeController {
  ...
  public getAll = async (
    ...
    try {
      ...
      let data = await this.userContactTypeService.getAll(queryParams.getQueryObj(), orderBy, limit, offset);
  ...
  public get = async (
    ...
    try {
      ...
      let data = await this.userContactTypeService.get(id, queryParams.getQueryObj());
