...
export class PriorityController {
  ...
  // ** ATRIBUTOS
  // ************************************************************************************************
  private TRANSLATION_NAME_MODEL : string = 'PRIORITY';
  public priorityService : PriorityService = new PriorityService();
  ...
  public create = async (
    ...
    try {
      ...
      const priority: Priority = new Priority(req.body);
  ...
  public createList = async (
    ...
    try {
      ...
      const prioritys: Priority[] = req.body;
  ...
  public getAll = async (
    ...
    try {
      ...
      let data = await this.priorityService.getAll(queryParams.getQueryObj(), orderBy, limit, offset);
  ...
  public get = async (
    ...
    try {
      ...
      let data = await this.priorityService.get(id, queryParams.getQueryObj());
  ...
  // ************************************************************************************************
  /**
   * Comproba se o Priority pasado ten os atributos mínimos que o modelo necesita.
   *
   * @param item Priority que se vai a avaliar
   * @returns Boolean
   */
