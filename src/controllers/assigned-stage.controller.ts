...
export class AssignedStageController {
  ...
  public getAll = async (
    ...
    try {
      ...
      let data = await this.assignedStageService.getAll(queryParams.getQueryObj(), orderBy, limit, offset);
  ...
  public get = async (
    ...
    try {
      ...
      let data = await this.assignedStageService.get(id, queryParams.getQueryObj());
