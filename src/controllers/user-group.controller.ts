...
export class UserGroupController {
  ...
  public getAll = async (
    ...
    try {
      ...
      let data = await this.userGroupService.getAll(queryParams.getQueryObj(), orderBy, limit, offset);
  ...
  public get = async (
    ...
    try {
      ...
      let data = await this.userGroupService.get(id, queryParams.getQueryObj());
