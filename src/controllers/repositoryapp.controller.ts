...
export class RepositoryAppController {
  ...
  public getAll = async (
    ...
    try {
      ...
      let data = await this.repositoryAppService.getAll(queryParams.getQueryObj(), orderBy, limit, offset);
  ...
  public get = async (
    ...
    try {
      ...
      let data = await this.repositoryAppService.get(id, queryParams.getQueryObj());
