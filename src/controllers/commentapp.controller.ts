...
export class CommentAppController {
  ...
  public getAll = async (
    ...
    try {
      ...
      let data = await this.commentAppService.getAll(queryParams.getQueryObj(), orderBy, limit, offset);
  ...
  public get = async (
    ...
    try {
      ...
      let data = await this.commentAppService.get(id, queryParams.getQueryObj());
