...
describe('1: Probas DATOS API - Priorities (GET)', () => {
    ...
    // ** TESTS
    // ************************************************************************************************
    test('1.1: Consultar tódolas Priorities:', async() => {
        ...
        expect(message).toBe(i18next.t('PRIORITY.SERVICE.SUCCESS.GET_LIST'));
    });
    ...
    test(`1.3: Consultar Priority: <${dataList.priorities[0].id}>`, async() => {
        ...
        expect(message).toBe(i18next.t('PRIORITY.SERVICE.SUCCESS.GET'));
    });
...
describe('2: Probas DATOS API - Priorities ERROS (GET)', () => {
    // ************************************************************************************************
    // ** ATRIBUTOS
    // ************************************************************************************************
    const ENDPOINT = "priorities";
    ...
    test('2.1: Consultar tódolas Priorities con parámetros de filtrado :', async() => {
        ...
        expect(error).toBe(i18next.t('PRIORITY.SERVICE.ERROR.GET_LIST'));
    });
    ...
    test(`2.2: Consultar Priority: <${dataList.priorities[0].id}> con parámetros de filtrado`, async() => {
        ...
        expect(error).toBe(i18next.t('PRIORITY.SERVICE.ERROR.GET'));
    });
