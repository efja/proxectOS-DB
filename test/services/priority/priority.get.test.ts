...
describe('1: Probas DATOS API - Priorities (GET)', () => {
    ...
    test('1.1: Consultar tódolas Priorities:', async() => {
        ...
        expect(message).toBe(i18next.t('SUCCESS.GET_LIST', { entity: i18next.t('PRIORITY.NAME_PLURAL') }));
    });
...
describe('2: Probas DATOS API - Priorities ERROS (GET)', () => {
    ...
    test('2.1: Consultar tódolas Priorities con parámetros de filtrado :', async() => {
        ...
        expect(error).toBe(i18next.t('ERROR.NOT_FOUND_LIST', { entity: i18next.t('PRIORITY.NAME_PLURAL') }));
    });
