...
describe('1: Probas DATOS API - Resources (DELETE)', () => {
    ...
    test(`1.1: Borrar Resource: <${dataList.resources[0].id}>`, async() => {
        ...
        expect(message).toBe(i18next.t('SUCCESS.DELETE', { entity: i18next.t('RESOURCE.NAME') }));
        ...
        expect(errorGet).toBe(i18next.t('ERROR.NOT_FOUND', { entity: i18next.t('RESOURCE.NAME') }));
    });
});
...
describe('2: Probas DATOS API - Resources ERROS (DELETE)', () => {
    ...
    test(`2.1: Borrar Resource inexistente:`, async() => {
        ...
        expect(error).toBe(i18next.t('ERROR.DELETE', { entity: i18next.t('RESOURCE.NAME') }));
    });
});
