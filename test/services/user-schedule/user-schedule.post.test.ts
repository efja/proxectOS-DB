...
describe('1: Probas DATOS API - UserSchedules (POST)', () => {
    ...
    test(`1.1: Crear UserSchedule: <${dataList.userSchedules[0].id}>`, async() => {
        ...
        expect(message).toBe(i18next.t('SUCCESS.CREATE', { entity: i18next.t('USER_SCHEDULE.NAME') }));
    });
    ...
    test('1.2: Crear lista de UserSchedules:', async() => {
        ...
        userSchedules[0]._id = new ObjectId("616c6b4c9c7900e7011c9615");
        userSchedules[0].id  = "616c6b4c9c7900e7011c9615";

        // Se cambian los identificadores para evitar conflictos
        userSchedules[1]._id = new ObjectId("616c6b6602067b3bd0d5ffbc");
        ...
        expect(message).toBe(i18next.t('SUCCESS.CREATE_LIST', { entity: i18next.t('USER_SCHEDULE.NAME_PLURAL') }));
    });
});
...
describe('2: Probas DATOS API - UserSchedules ERROS (POST)', () => {
    ...
    test(`2.1: Crear UserSchedule con datos erróneos:`, async() => {
        ...
        expect(error).toBe(i18next.t('ERROR.CREATE', { entity: i18next.t('USER_SCHEDULE.NAME') }));
    });
    ...
    test('2.3: Crear lista de UserSchedules algúns con datos erróneos:', async() => {
        ...
        // Se cambian los identificadores para evitar conflictos
        badUserSchedules[0]._id = new ObjectId("616c6b4c9c7900e7011c9615");
        badUserSchedules[0].id  = "616c6b4c9c7900e7011c9615";

        // Se cambian los identificadores para evitar conflictos
        badUserSchedules[1]._id = new ObjectId("616c6b6602067b3bd0d5ffbc");
        ...
        expect(error).toBe(i18next.t('ERROR.CREATE_LIST', { entity: i18next.t('USER_SCHEDULE.NAME_PLURAL') }));
    });
});