...
describe('1: Probas DATOS API - States (POST)', () => {
    ...
    test(`1.1: Crear State: <${dataList.states[0].id}>`, async() => {
        ...
        expect(message).toBe(i18next.t('SUCCESS.CREATE', { entity: i18next.t('STATE.NAME') }));
    });
    ...
    test('1.2: Crear lista de States:', async() => {
        ...
        expect(message).toBe(i18next.t('SUCCESS.CREATE_LIST', { entity: i18next.t('STATE.NAME_PLURAL') }));
    });
});
...
describe('2: Probas DATOS API - States ERROS (POST)', () => {
    ...
    test(`2.1: Crear State con datos erróneos:`, async() => {
        ...
        expect(error).toBe(i18next.t('ERROR.CREATE', { entity: i18next.t('STATE.NAME') }));
    });
    ...
    test(`2.2: Crear State: <${dataList.states[0].id}> QUE XA EXISTE`, async() => {
        ...
        expect(error).toBe(i18next.t('ERROR.ALREADY_EXIST', { entity: i18next.t('STATE.NAME'), id: state.id }));
    });
    ...
    test('2.3: Crear lista de States algúns con datos erróneos:', async() => {
        ...
        expect(error).toBe(i18next.t('ERROR.CREATE_LIST', { entity: i18next.t('STATE.NAME_PLURAL') }));
    });
});