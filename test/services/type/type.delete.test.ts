...
describe('1: Probas DATOS API - Types (DELETE)', () => {
    ...
    test(`1.1: Borrar Type: <${dataList.types[0].id}>`, async() => {
        ...
        expect(message).toBe(i18next.t('SUCCESS.DELETE', { entity: i18next.t('TYPE.NAME') }));
        ...
        expect(errorGet).toBe(i18next.t('ERROR.NOT_FOUND', { entity: i18next.t('TYPE.NAME') }));
    });
});
...
describe('2: Probas DATOS API - Types ERROS (DELETE)', () => {
    ...
    test(`2.1: Borrar Type inexistente:`, async() => {
        ...
        expect(error).toBe(i18next.t('ERROR.DELETE', { entity: i18next.t('TYPE.NAME') }));
    });
});
