...
describe('1: Probas DATOS API - CommentApps (POST)', () => {
    ...
    test(`1.1: Crear CommentApp: <${dataList.comments[0].id}>`, async() => {
        ...
        expect(message).toBe(i18next.t('SUCCESS.CREATE', { entity: i18next.t('COMMENT.NAME') }));
    });
    ...
    test('1.2: Crear lista de CommentApps:', async() => {
        ...
        expect(message).toBe(i18next.t('SUCCESS.CREATE_LIST', { entity: i18next.t('COMMENT.NAME_PLURAL') }));
    });
});
...
describe('2: Probas DATOS API - CommentApps ERROS (POST)', () => {
    ...
    test(`2.1: Crear CommentApp con datos erróneos:`, async() => {
        ...
        expect(error).toBe(i18next.t('ERROR.CREATE', { entity: i18next.t('COMMENT.NAME') }));
    });
    ...
    test('2.3: Crear lista de CommentApps algúns con datos erróneos:', async() => {
        ...
        expect(error).toBe(i18next.t('ERROR.CREATE_LIST', { entity: i18next.t('COMMENT.NAME_PLURAL') }));
    });
});